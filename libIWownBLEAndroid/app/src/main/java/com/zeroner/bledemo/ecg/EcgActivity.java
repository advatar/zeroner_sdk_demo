...
public class EcgActivity extends AppCompatActivity {
    ...
    private void initdata() {
        ...
        list = DataSupport.where("data_from=? ", deviceName).find(TB_64_data.class);
        List<TB_64_index_table> index_tables = DataSupport.where("data_from=? ", deviceName).limit(50).find(TB_64_index_table.class);
